    ...
    return (
        <section className={"login-background"}>
            ...
            <div className="container my-5">
                ...
                {/*<p className="text-muted w-100 pb-3">*/}
                {/*    Got question regarding your pets? Or wanna reach us out for any reasons here you go..*/}
                {/*</p>*/}
                        ...
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="card-body form">
                                    ...
                                    {/*    <i className="fas fa-envelope pr-2 mr-1"/>Write to us:</h3>*/}
